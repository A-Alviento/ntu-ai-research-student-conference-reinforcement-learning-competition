...
DELTA                       =      0.5             #   How much should the epsilon shift by in every game
LR                          =      0.5            #   This is the learning rate. High learning rate means faster learning"
GAMMA                       =      0.8              #   gamma = discount factor. High gamma value means focus on future rewards "
STARTING_EPSILON            =      1

#These are the reward parameters. You need to change this. Refer to the guide to know what each means in detail
DESTROY_SOFTBLOCK           =      100
DO_DAMAGE                   =      200
TAKE_DAMAGE                 =      -150
EARN_AMMO                   =      30
COLLIDE_WITH_WALLS          =      -20
DAMAGE_ITSELF               =      -100
NO_DESTRUCTION              =      -50
NO_KILL                     =      -50
